...
//             {[
//               { icon: Users, label: "✦ We've done this 500+ times — your category included. Skincare. Jewelry. Apparel. FMCG. Home decor. Bamboo. Ayurvedic. We don't learn on your project. By the time we open your brief, we already know what works for your category on your platform." },
//               { icon: Globe, label: "✦ Platform compliance isn't a bonus — it's the baseline. Amazon's 2000×2000px pure white. Flipkart's infographic specs. Nykaa's lifestyle ratios. Every file we deliver is platform-ready, rejection-proof, and upload-ready the day you receive it." },
//               { icon: TrendingUp, label: "✦ Every day your listing looks average, you're paying for it. Not to us — to your competitor. Every scroll-past is a sale lost. Every blurry infographic is a customer who clicked away. The cost of bad visuals isn't the design fee. It's every order that didn't happen." },
//               { icon: ArrowRight, label: "✦ Results sellers actually talk about. 3x CTR improvements. Higher BSR. More add-to-carts. We don't measure success by how beautiful the file looks — we measure it by what happens to your numbers after you upload it." },
//               { icon: Users, label: "✦ Mon–Sat, 10AM–7PM — and we actually reply. No ghosting after delivery. No \"please allow 5–7 business days.\" Real people, real responses. New SKU, urgent revision, last-minute festival catalog — we're built for the pace Indian e-commerce actually runs at." }
//             ].map((item, i) => (
//               <div key={i} className="flex items-center gap-2 text-sm ">
//                 {/* <item.icon size={16} className="text-primary" /> */}
//                 <span className="font-bold bg-gradient-to-b from-[#7B2FD9] to-[#60B8F0] text-transparent bg-clip-text">{item.label}</span>
//               </div>
//             ))}
//           </div>
